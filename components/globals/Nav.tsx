...
const Nav = () => {
  return (
    <nav className='flex justify-between gap-3 py-6 border-b-2 border-color bg-white md:px-12 px-6 fixed w-full z-20'>
      ...
      <Link href="https://www.buymeacoffee.com/xnyderhq" className='md:flex-none flex-1 w-48'><img src="https://img.buymeacoffee.com/button-api/?text=Buy me a coffee&emoji=☕&slug=xnyderhq&button_colour=2852DC&font_colour=ffffff&font_family=Lato&outline_colour=000000&coffee_colour=FFDD00"  className='w-48 ml-auto' alt="Buy Xnyder a coffee"/></Link>
    </nav>
  )
}
